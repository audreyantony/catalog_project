...
function fetchClearance($db){
    $query = "SELECT id_product, LEFT(name_product, 25) as name, LEFT(description_product, 60) as descr, discount_product as discount FROM product WHERE discount_product > 0 LIMIT 3;";
